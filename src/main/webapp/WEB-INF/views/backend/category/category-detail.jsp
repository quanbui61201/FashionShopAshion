...
<head>
	...
	<title>Admin Category Management | View Category Detail</title>
...
<body class="">
				...
				<div class="row">
					<div class="col">
						<div class="card">
							...
							<div class="card-body">
								<sf:form id="categoryForm" class="form" modelAttribute="category">
									...
									<div class="row">
										<div class="col-md-3 pr-md-1">
											<div class="form-group">
		                                        ...
		                                        <sf:select path="userCreateCategory.id" class="form-control text-primary" id="userCreateCategory">
                        		 		...
                        		 		<div class="col-md-3 pr-md-1">
											<div class="form-group">
		                                        ...
		                                        <sf:select path="userUpdateCategory.id" class="form-control text-primary" id="userUpdateCategory">
		                                            <sf:options items="${users }" itemValue="id" itemLabel="username"></sf:options>
		                                        </sf:select>
                                       		</div>
                                    	</div>
								...
								<div class="row">
										...
										<div class="form-group mb-4">
	                                        <a href="${classpath }/admin/category/list" class="btn btn-fill btn-primary" role="button" aria-pressed="true">
	                                        	Back to list
	                                        </a>
                                    	</div>
                                   	</div>
	...
	<script>
	    $(document).ready(function() {
	    	$('#categoryForm .form-group').css('pointer-events', 'none');
	    });
	</script>
