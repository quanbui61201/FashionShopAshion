...
<head>
	...
	<title>Admin Role Management | View Role Detail</title>
...
<body class="">
					...
					<div class="col">
						<div class="card">
							<div class="card-header">
								<h3 class="title">Role Detail</h3>
							</div>
							<div class="card-body">
								<sf:form id="roleForm" class="form" modelAttribute="role">
	...
	<script>
	    $(document).ready(function() {
	    	$('#roleForm .form-group').css('pointer-events', 'none');
	    });
	</script>
