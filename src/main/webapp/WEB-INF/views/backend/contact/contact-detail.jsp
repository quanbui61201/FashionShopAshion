...
<head>
	...
	<title>Admin Contact Management | View Contact Detail</title>
...
<body class="">
				...
				<div class="row">
					<div class="col">
						<div class="card">
							...
							<div class="card-body">
								<sf:form id="contactForm" class="form" modelAttribute="contact">
	...
	<script>
	    $(document).ready(function() {
	    	$('#contactForm .form-group').css('pointer-events', 'none');
	    });
	</script>
