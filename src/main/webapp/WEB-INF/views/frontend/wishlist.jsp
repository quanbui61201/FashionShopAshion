...
<body>
    ...
    <section class="shop spad">
        <form action="${classpath }/wishlist" method="get">
	        <div class="container">
	            <div class="row">
                     ...
                     <div class="col-lg-12 text-center">
                         <div class="pagination_option">
					        ...
					        <c:if test="${productSearch.currentPage < totalPage}">
    ...
    <script>
    	removeFromWishlist = function(_productId) {
			//$ === jQuery
			jQuery.ajax({
				url : "/remove-from-wishlist/" + _productId,
				type : "DELETE",
